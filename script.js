document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .pricing-card, .testimonial-card, .team-card, .service-card, .hero-content, .section-header, .cta-block'
  );
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el, index) {
      ...
      if (delay) {
        ...
        const siblings = el.parentNode ? el.parentNode.querySelectorAll('.' + ANIMATION_CLASS) : [];
        let siblingIndex = 0;
        siblings.forEach(function (sib, i) {
          if (sib === el) siblingIndex = i;
        });
    ...
    if ('IntersectionObserver' in window) {
      ...
      function checkVisibility() {
        ...
        animatedElements.forEach(function (el) {
          ...
          const visiblePoint = elementTop + rect.height * ANIMATION_THRESHOLD;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '91120fcf-7feb-462c-9809-65dc20f7cc6f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '91120fcf-7feb-462c-9809-65dc20f7cc6f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bdb690bc-9c36-4110-b9de-d9903ca6fbec';
